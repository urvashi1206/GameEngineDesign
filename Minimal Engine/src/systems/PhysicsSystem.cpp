...
namespace Minimal {
    ...
    bool PhysicsSystem::GJK(const TransformComponent &transformA, const ColliderComponent &a, const TransformComponent &transformB, const ColliderComponent &b,
    ...
    std::vector<ContactPoint> PhysicsSystem::EPA(std::deque<glm::vec3> simplex, std::unordered_map<glm::vec3, std::pair<glm::vec3, glm::vec3> > supportPoints,
                                                 const TransformComponent &transformA, const ColliderComponent &a, const TransformComponent &transformB,
    ...
    void PhysicsSystem::EPA_GetPolytopeNormals(std::vector<glm::vec3> polytope, std::vector<unsigned int> faces, std::vector<std::pair<glm::vec3, float> > &out_normals,
    ...
    std::vector<glm::vec3> PhysicsSystem::EPA_GetAlignedFace(const TransformComponent &transform, const ColliderComponent &collider, const glm::vec3 &direction,
